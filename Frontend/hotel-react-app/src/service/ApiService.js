...
export default class ApiService {
    ...
    static async updateUser(id, formData){
        const response = await axios.put(`${this.BASE_URL}/users/update?id=${id}`, formData, {
    ...
    static async verifyOtp(otp) {
        const response = await axios.post(`${this.BASE_URL}/forgotPassword/verifyOtp/${otp}`)
        return response.data
    }

    static async changePassword(otp, password) {
        const response = await axios.post(`${this.BASE_URL}/forgotPassword/changePassword/${otp}/${password}`)
        return response.data
    }
